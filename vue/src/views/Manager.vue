    ...
    <div style="height: 60px; background-color: #2e3143; display: flex; align-items: center; border-bottom: 1px solid #ddd">
      <div style="flex: 1">
        <div style="padding-left: 20px; display: flex; align-items: center">
          ...
          <div style="font-weight: bold; font-size: 24px; margin-left: 5px; color: #fff">社区家电回收预约</div>
        </div>
      </div>
    ...
    <div style="display: flex">
      <div style="width: 200px; border-right: 1px solid #ddd; min-height: calc(100vh - 60px)">
        ...
        >
          ...
          <el-menu-item index="/manager/appliance-type">
            <el-icon><Odometer /></el-icon>
            <span>家电类型管理</span>
            </el-menu-item>

            <el-menu-item index="/manager/recycle-order">
          ...
          <el-sub-menu index="user">
            ...
            <el-menu-item index="/manager/collector">
              <el-icon><User /></el-icon>
              <span>回收员信息</span>
            </el-menu-item>
