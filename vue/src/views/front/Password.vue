<template>
  <div class="front-container" style="width: 40%">
    <div class="card"  style=" padding: 20px">
      <div style="font-size: 20px; margin-bottom: 20px; text-align: center;">修改密码</div>
...
const data = reactive({
  ...
  rules:{
    password: [
      { required: true, message: '请输入原密码', trigger: 'blur' },  //trigger是鼠标触发时机,blur是释交触发
    ],
    newPassword: [
      { required: true, message: '请输入新密码', trigger: 'blur' },  //trigger是鼠标触发时机,blur是释交触发
    ],
    confirmPassword: [
      { required: true, message: '请确认新密码', trigger: 'blur' },  //trigger是鼠标触发时机,blur是释交触发
    ]
  }
})
